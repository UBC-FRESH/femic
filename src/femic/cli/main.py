...
def run_all(
    ...
    pipeline_run_config = build_pipeline_run_config(
        ...
        strat_target_nstrata=effective.strat_target_nstrata,
        tipsy_vdyp_ylim=effective.tipsy_vdyp_ylim,
        ...
        vdyp_force_tail_blend=effective.vdyp_force_tail_blend,
        vdyp_enable_late_gate_rescue=effective.vdyp_enable_late_gate_rescue,
