...
- [ ] P60.5 Build the canonical AU table and AU-wise first-growth curve lane (`#173`)
  ...
  - [ ] P60.5d Publish the canonical top-N AU selection using an `80%` cumulative-area coverage rule so downstream runtime generation consumes an explicit selected AU subset rather than the full AU universe by default.
