...
[task] GitHub issue #49 is still open, but the final comment seems to indicate that this has fully landed and should in fact be closed. Investigate and close if appropriate.
